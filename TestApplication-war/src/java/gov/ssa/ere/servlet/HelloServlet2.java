...
public class HelloServlet2 extends HttpServlet {
    ...
    protected void processRequest(HttpServletRequest request, HttpServletResponse response)
        ...
        try (PrintWriter out = response.getWriter()) {
            ...
            out.println("<html>");
            out.println("<head>");
            out.println("<title>Servlet HelloServlet2</title>");            
            out.println("</head>");
            out.println("<body>");
            out.println("<h1>Servlet HelloServlet2 at " + request.getContextPath() + "</h1>");
            out.println("The result of the call is " + myBean.doSomethingFor30Seconds());
            out.println("</body>");
            out.println("</html>");
        }
    }
